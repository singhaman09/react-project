...
function CountryDetail() {
  ...
  const { ref: backRef, focusKey: backFocused } = useFocusable({
    ...
    isFocusable: true,
    onEnterPress: () => {
      navigate('/country'); // Adjust this path to match your countries list route
    },
  });
        ...
        <main className="flex-grow flex flex-col items-center justify-center p-6 sm:p-10">
          <div className="w-full max-w-2xl mb-6">
            <button
              ...
              className="px-6 py-3 bg-orange-600 text-black font-semibold rounded-lg hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-colors duration-200"
            >
              ← Back to Countries
            </button>
          </div>
